<?php
/* Smarty version 4.5.5, created on 2026-01-05 17:15:59
  from '/Applications/MAMP/htdocs/custom/panel_templates/Default/core/pages_edit.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_695be3bfcd1649_21328807',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '5fee55865793c64dce1a644b187c953555edf02b' => 
    array (
      0 => '/Applications/MAMP/htdocs/custom/panel_templates/Default/core/pages_edit.tpl',
      1 => 1745235519,
      2 => 'file',
    ),
  ),
...
function content_695be3bfcd1649_21328807 (Smarty_Internal_Template $_smarty_tpl) {
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            ...
                            <div class="row" style="margin-bottom: 10px;">
                                <div class="col-md-9">
                                    <h5 style="margin-top: 7px; margin-bottom: 7px;"><?php echo $_smarty_tpl->tpl_vars['EDITING_PAGE']->value;?>
</h5>
                                </div>
                                <div class="col-md-3">
...
">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="link_location" name="link_location">
                                        <option value="1" <?php if ($_smarty_tpl->tpl_vars['PAGE_LINK_LOCATION_VALUE']->value == 1) {?> selected<?php }?>>
                                            <?php echo $_smarty_tpl->tpl_vars['PAGE_LINK_NAVBAR']->value;?>
</option>
                                        <option value="2" <?php if ($_smarty_tpl->tpl_vars['PAGE_LINK_LOCATION_VALUE']->value == 2) {?> selected<?php }?>>
                                            <?php echo $_smarty_tpl->tpl_vars['PAGE_LINK_MORE']->value;?>
</option>
                                        <option value="3" <?php if ($_smarty_tpl->tpl_vars['PAGE_LINK_LOCATION_VALUE']->value == 3) {?> selected<?php }?>>
                                            <?php echo $_smarty_tpl->tpl_vars['PAGE_LINK_FOOTER']->value;?>
</option>
                                        <option value="4" <?php if ($_smarty_tpl->tpl_vars['PAGE_LINK_LOCATION_VALUE']->value == 4) {?> selected<?php }?>>
                                            <?php echo $_smarty_tpl->tpl_vars['PAGE_LINK_NONE']->value;?>
</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group custom-control custom-switch">
                                    <input id="inputBasicPage" name="basic" type="checkbox" class="custom-control-input"
                                        <?php if ($_smarty_tpl->tpl_vars['BASIC_PAGE_VALUE']->value == 1) {?> checked<?php }?> />
                                    <label class="custom-control-label" for="inputBasicPage"><?php echo $_smarty_tpl->tpl_vars['BASIC_PAGE']->value;?>
</label>
                                </div>
                                <div class="form-group custom-control custom-switch">
                                    <input id="inputRedirect" name="redirect_page" type="checkbox"
                                        class="custom-control-input" <?php if ($_smarty_tpl->tpl_vars['PAGE_REDIRECT_VALUE']->value == 1) {?> checked<?php }?> />
                                    <label class="custom-control-label" for="inputRedirect"><?php echo $_smarty_tpl->tpl_vars['PAGE_REDIRECT']->value;?>
</label>
                                </div>
                                <div class="form-group">
...
">
                                ...
                                <div class="form-group custom-control custom-switch">
                                    <input id="inputTarget" name="target" type="checkbox" class="custom-control-input"
                                        <?php if ($_smarty_tpl->tpl_vars['TARGET_VALUE']->value == 1) {?> checked<?php }?> />
                                    <label class="custom-control-label" for="inputTarget"><?php echo $_smarty_tpl->tpl_vars['TARGET']->value;?>
</label>
                                </div>
                                <div class="form-group custom-control custom-switch">
                                    <input id="inputUnsafeHTML" name="unsafe_html" type="checkbox"
                                        class="custom-control-input" <?php if ($_smarty_tpl->tpl_vars['UNSAFE_HTML_VALUE']->value == 1) {?> checked<?php }?> />
                                    <label class="custom-control-label" for="inputUnsafeHTML"><?php echo $_smarty_tpl->tpl_vars['UNSAFE_HTML']->value;?>
</label>
...
"
                                ...
                                <div class="form-group custom-control custom-switch">
                                    <input id="inputSitemap" name="sitemap" type="checkbox" class="custom-control-input"
                                        <?php if ($_smarty_tpl->tpl_vars['INCLUDE_IN_SITEMAP_VALUE']->value == 1) {?> checked<?php }?> />
                                    <label class="custom-control-label" for="inputSitemap"><?php echo $_smarty_tpl->tpl_vars['INCLUDE_IN_SITEMAP']->value;?>
</label>
                                </div>
                                <hr />
